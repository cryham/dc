...
begin
  ...
  begin
    ...
    begin
      ...
      gSyncDirsAsymmetricSave := GetAttr(Node, 'AsymmetricSave', gSyncDirsAsymmetricSave);
...
begin
  ...
  begin
    ...
    SetAttr(Node, 'AsymmetricSave', gSyncDirsAsymmetricSave);
